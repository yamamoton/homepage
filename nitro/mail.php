...
$site_top = "http://mizuuchi.lab.tuat.ac.jp/~yamamoton/index.html";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "r14.cycle@gmail.com";
...
$Referer_check_domain = "mizuuchi.lab.tuat.ac.jp";
...
$thanksPage = "http://mizuuchi.lab.tuat.ac.jp/~yamamoton/thanks.html";
	...
	<div id="fh5co-page">
		...
		<aside id="fh5co-aside" role="complementary" class="border">
			...
			<div class="fh5co-footer">
				...
				<ul>
					<li><a href="https://www.facebook.com/profile.php?id=100008942223672"><i class="icon-facebook"></i></a></li>
					<li><a href="https://twitter.com/anthem0f"><i class="icon-twitter"></i></a></li>
				</ul>
			</div>
...
<?php if($empty_flag == 1){ ?>
<div align="center">
				<h3>入力にエラーがあります。<br>下記をご確認の上「戻る」ボタンにて修正をお願い致します。</h3>
...
送信ありがとうございました。<br />
送信は正常に完了しました。<br /><br />
<a href="<?php echo $site_top ;?>">Home<!-- &raquo; --></a>
</div>
</div>
<?php copyright(); ?>
